$(function() {
	...
	function preclick() {
		...
		if (currrentindex != 0) {
			var curli = getli.eq(currrentindex);
			var length = getli.length;
			if (currrentindex <= (length="" -="" 5))="" {="" getli.eq(currrentindex="" +="" 4).css("display",="" "none");="" 1).css("width",="" "116px").css("display",="" "block")="" }="" var="" curnextli="getli.eq(currrentindex" 1);="" curnextsrc="curnextli.find("img").attr("bigimg");" curnexttxt="curnextli.find("img").attr("text");" curli.find("img").removeclass("selectpic");="" curnextli.find("img").addclass("selectpic");="" $("#pic1").attr("src",="" curnextsrc);="" $(".picshowtxt_right").text(curnexttxt);="" $("#pic1").attr("curindex",="" currrentindex="" $(".picshowtxt_left="" span").text(currrentindex)="" else="" $(".bodymodal").css("display",="" "block");="" $(".firsttop").css("display",="" $("#prearrow_b").click(function()="" preclick()="" });="" $("#prearrow").click(function()="" getli.click(function()="" currentliindex="$(this).index(".picmidmid" ul="" li");="" $(".picmidmid="" li="" img[class="selectpic" ]").removeclass("selectpic");="" currentli="getli.eq(currentliindex);" currentli.find("img").addclass("selectpic");="" bigimgsrc="currentli.find("img").attr("bigimg");" bigimgsrc);="" currentliindex);="" span").text(currentliindex="" 1)="" $(".piclistshow="" li").click(function()="" curli="$(this).index(".piclistshow" showgaoqing();="" curli);="" span").text(curli="" li").css("display",="" if="" (curli="">= 5) {
			var cha = curli - 5;
			for (var i = 0; i </=>