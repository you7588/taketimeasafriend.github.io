(function (window, undefined) {
    ...
    ifeng.Gallery = function (options) {
		...
		(function(){
			...
			for(var i = 0;i<len;i++){ o.thumbs.push(list[i]);="" }="" })();="" t.size="t.data.length;" t.offsetsize="o.thumbs.length" ;="" t.loadlazyquene="[];" for(var="" i="t.offsetSize" <="" t.size;i++){="" t.loadlazyquene.push(t.data[i]);="" var="" pwidth="o.photoView.offsetWidth," pheight="o.photoView.offsetHeight;" uwidth="o.thumbs[0].offsetWidth," twidth="uWidth" *="" t.size,="" tcntwidth="o.thumb.parentNode.offsetWidth," tnum="Math.floor(tCntWidth" uwidth);="" tnum;="" o.setstyle(o.photoview,="" "width",="" +="" 'px');="" o.setstyle(o.thumb,="" (twidth+2)="" ie6兼容增加2px="" o.setstyle(o.boxscrl,="" (tcntwidth="" o.btnscrlprev.offsetwidth="" 2)="" bcntwidth="o.bar.parentNode.offsetWidth," bwidth="Math.max(36," math.min(tcntwidth="" twidth,="" bcntwidth));="" o.setstyle(o.bar,="" len="t.size;" while="" (++i="" len)="" {="" self="t.data[i]," id="self.img.substr(self.img.lastIndexOf('/')+1,self.img.lastIndexOf('.')-self.img.lastIndexOf('/')-1);" mult="Math.max(0," math.min(i="" -="" math.floor((tnum="" 1)="" 1,="" tnum));="" t.photoinfo.push({="" id:="" id,="" desc:="" self.title,="" img:="" self.img,="" timg:="" self.timg,="" listimg:="" self.listimg,="" pos:="" mult,="" picwidth:self.picwidth,="" picheight:self.picheight,="" morelink:self.morelink="" });="" t.photoindex[id]="i+1;" t.bar="new" ifeng.scroll(o.thumb,="" 'x',="" o.bar);="" addlistener([o.btnscrlprev,="" o.btnscrlnext,="" o.bar],="" 'click',="" function="" (event,="" dom)="" event.preventdefault="" ?="" event.preventdefault()="" :="" (event.returnvalue="false);" o.btnscrlnext="" ],="" 'dblclick',="" for="" clear="" selection="" area="" window.getselection="" window.getselection().removeallranges()="" document.selection.empty();="" addlistener(o.btnscrlprev,="" 'mousedown',="" t.bar.start.bind(t.bar,="" 'forward'))="" 'mouseup',="" t.bar.stop.bind(t.bar));="" 'mouseout',="" addlistener(o.btnscrlnext,="" 'backward'));="" alist="[o.photoPrev," o.photonext];="" add="" event="" loaded="" li="" array.prototype.push.call(alist,="" o.thumbs[i].getelementsbytagname("a")[0]);="" addlistener(alist,="" ohash="t.parseObj(dom.href);" if="" (ohash.p)="" t.showphoto(ohash.p).changehash('p=" + oHash.p);
            }
        });
        
		addListener(o.photoPrevLoading, " load',="" (ev,="" (new="" image).src="t.photoInfo[parseInt(oHash.p)" 1].timg;="" if(!ohash.p){="" stasign="false;" t.changehash("p="1");" load="" left="" img="" (function(){="" obj,="" ofragmeng="document.createDocumentFragment();" 创建文档碎片;="" while((obj="t.loadlazyQuene.shift())!=null){" a="document.createElement("a")," a.href="#p=" (t.size="" t.loadlazyquene.length);="" a.hidefocus="true" a.innerhtml="<img src=\" "+obj.img="" "\"="">" ;
					li.appendChild(a);
					o.thumbs.push(li); 
		...
		addListener(o.moreRight,"click",function(e){
			if(t .currentPageIndex <= 1="" t="" .pagesize="" -2="" ){="" t.currentpageindex="parseInt(t.currentPageIndex)" +1;="" t._timer="setInterval(t.listAnimate.bind(t),t.interval);" t.setactivepage();="" }="" })="" addlistener(o="" .showallpic,"click",t.changelistmode.bind(t))="" **="" start="" for="" full="" mode---end**="" };="" ifeng.gallery.prototype="{" 加载图片页统计脚本="" loadsta="" :="" function()="" {="" var="" head="document.getElementsByTagName('head');" stascript="document.createElement('script');" staurl="http://sta.ifeng.com/stadig/sta_collection_nopack.js" ;="" stascript.setattribute('src',="" staurl);="" stascript.setattribute('type',="" 'text="" javascript');="" head[0].appendchild(stascript);="" },="" showphoto:="" function="" (id)="" index="isNaN(id)" ?="" (parseint(id="" )="" <=""> t.size? t.size : parseInt(id )) ),			
            ...
            if (info.timg != t.o.photo.src || index ==1) {
                ...
                t.bar.onStart = function () {
                    ...
                    if(t.size<=5){ o.scrlprev_b.classname="no" ;="" o.scrlnext_b.classname="no" o.scrlprev_b.style.cursor="default" o.scrlnext_b.style.cursor="default" o.bar.classname="drag_no" }="" };="" t.bar.scrollto(info.pos);="" t.o.btnorig="" &&="" (t.o.btnorig.href="info.timg);" return="" t;="" },="" resize:="" function="" ($img,="" size)="" {="" $img.removeattribute('width');="" $img.removeattribute('height');="" size="size" ||="" {};="" var="" rw="size.width" ?="" $img.width="" size.width="" :="" 0,="" rh="size.height" $img.height="" size.height="" 0;="" if="" (rw=""> 1 || rh > 1) {
